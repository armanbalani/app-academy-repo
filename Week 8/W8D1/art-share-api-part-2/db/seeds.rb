...
Comment.create(user_id: 1, artwork_id: 1, body: "apollo is great wow")
Comment.create(user_id: 2, artwork_id: 1, body: "apollo is amazing wowwowowoww")
Comment.create(user_id: 3, artwork_id: 2, body: "buddyup is great wow")
Comment.create(user_id: 1, artwork_id: 3, body: "beauty is great wow")
Comment.create(user_id: 2, artwork_id: 4, body: "love is great wow")
Comment.create(user_id: 3, artwork_id: 5, body: "monalisa is great wow")